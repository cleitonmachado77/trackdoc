...
export default function VerifyDocumentRPC() {
  ...
  const verifyDocument = async (verificationCode: string) => {
    try {
      ...
      // Usar função RPC para buscar dados
      ...
      const formattedData: VerificationData = {
        ...
        user_email: signatureData.user_email,
        user_metadata: signatureData.user_metadata,
        document_title: signatureData.document_title,
        document_file_path: signatureData.document_file_path
      }
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-gray-900">{verificationData.document_title || 'Documento direto'}</p>
              </div>
              <div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <p className="text-gray-900">
                  {verificationData.user_metadata?.full_name || verificationData.user_email || 'Usuário'}
                </p>
              </div>
              <div>
                <label className="text-sm font-medium text-gray-500">E-mail</label>
                <p className="text-gray-900">{verificationData.user_email || 'N/A'}</p>
              </div>
            </div>
          </CardContent>
        </Card>
